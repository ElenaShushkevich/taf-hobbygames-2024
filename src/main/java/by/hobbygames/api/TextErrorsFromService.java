...
public class TextErrorsFromService {
    ...
    public static final String ERRORS_WITH_EMPTY_PHONE = "Данные не введены";
    public static final String ERRORS_WITH_EMPTY_PHONE_EMAIL = "Введите телефон или электронную почту";
}
