...
public class CheckoutPageLocators {
    ...
    public static final String DELIVERY_ERROR_XPATH = "//span[@class ='error delivery-group-not-selected-error']";
    ...
    public static final String PALAZZO_STORES_XPATH = "//*[@id=\"74\"]";
    public static final String ADDED_STORES_TO_DELIVERY = "//label[@for='option-74-0']";
